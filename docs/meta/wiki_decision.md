...
| JÄSENPOLKU | [E-pyöräilyn työkalulinkit](../JASENPOLKU/e_pyorailyn_tyokalulinkit.md) | Poimittu linkkirekisteristä (ks. alla) — joku yhteisössä oli jo koostanut tämän kerran, se ei saa hautautua Discordiin. |
...
| `link_registry.md` — **päivitetty 2026-08-13, käyty läpi yksitellen** | Alkuperäinen 699 linkin tilastoyhteenveto ei itsessään ole artikkeli, mutta linkit käytiin nyt yksitellen läpi. Noin 85 % (kisatallenteet, kertaluonteiset event-linkit) jää edelleen Discordiin — nämä eivät ole pysyviä. Pieni joukko toistuvasti käytettyjä, pysyviä linkkejä (ZwiftPower-tiimi, RCF Cup/Kuutar/Category Spotlight -tapahtumatagit, RCF Shop, Moomoo, rideclub.fi, Sesh, WTRL:n viralliset sivut) nostettiin [resurssi-inventaarioon](../YLLAPITO/resource_inventory.md). Valmiiksi koostettu, jo kuratoitu e-pyöräilyn työkalulinkkikokoelma nostettiin omaksi sivukseen: [E-pyöräilyn työkalulinkit](../JASENPOLKU/e_pyorailyn_tyokalulinkit.md). Kaksi asiaa jäi tarkoituksella avoimeksi eikä niitä merkitty kanoniseksi: RCF:n Zwift Club -linkistä löytyi kolme eri club-ID:tä eri ajankohdilta, ja Discord-kutsulinkistä kaksi eri linkkiä — kumpaakaan ei arvattu, koska väärä linkki olisi pahempi kuin puuttuva. |
