...
- **Sesh**: Discord-eventtien ja tapahtumakalenterin resurssi, premium-tilaus käytössä.
- **RCF-eventkalenteri**: Google Sheets -pohjainen tapahtumien aikataulunäkymä.
...
- raakalinkit, koodit ja määräaikaiset edut — näitä on n. 700 kappaletta pinned-viesteissä; ne jäävät elämään Discordiin, kunnes joku ottaa linkkirekisterin omistajuuden ja käy ne yksitellen läpi
- vanhat rosterit ja henkilölistat — eivät koskaan wikiin
